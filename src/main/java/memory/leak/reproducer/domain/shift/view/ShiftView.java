...
package memory.leak.reproducer.domain.shift.view;
...
import memory.leak.reproducer.domain.common.AbstractPersistable;
import memory.leak.reproducer.domain.common.DateTimeUtils;
import memory.leak.reproducer.domain.employee.Employee;
import memory.leak.reproducer.domain.shift.Shift;
import memory.leak.reproducer.domain.spot.Spot;
import memory.leak.reproducer.domain.violation.ContractMinutesViolation;
import memory.leak.reproducer.domain.violation.DesiredTimeslotForEmployeeReward;
import memory.leak.reproducer.domain.violation.RequiredSkillViolation;
import memory.leak.reproducer.domain.violation.RotationViolationPenalty;
import memory.leak.reproducer.domain.violation.ShiftEmployeeConflict;
import memory.leak.reproducer.domain.violation.UnassignedShiftPenalty;
import memory.leak.reproducer.domain.violation.UnavailableEmployeeViolation;
import memory.leak.reproducer.domain.violation.UndesiredTimeslotForEmployeePenalty;
