...
package memory.leak.reproducer.generator;
...
import memory.leak.reproducer.domain.contract.Contract;
import memory.leak.reproducer.domain.employee.Employee;
import memory.leak.reproducer.domain.employee.EmployeeAvailability;
import memory.leak.reproducer.domain.employee.EmployeeAvailabilityState;
import memory.leak.reproducer.domain.roster.Roster;
import memory.leak.reproducer.domain.roster.RosterState;
import memory.leak.reproducer.domain.rotation.ShiftTemplate;
import memory.leak.reproducer.domain.shift.Shift;
import memory.leak.reproducer.domain.skill.Skill;
import memory.leak.reproducer.domain.spot.Spot;
import memory.leak.reproducer.domain.tenant.RosterParametrization;
import memory.leak.reproducer.domain.tenant.Tenant;
...
public class RosterGenerator {
    ...
    private void setId(AbstractPersistable p) {
